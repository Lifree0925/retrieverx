...
|---|---|---|---|---|
| BM25 Only（仅关键词） | 0.9841 | 0.9053 | 0.9176 | 11.2 ms |
| Vector Only（仅向量） | 0.9841 | 0.9101 | 0.9288 | 90.3 ms |
| Hybrid（RRF 融合） | 0.9841 | 0.9259 | 0.9411 | 88.8 ms |
| Hybrid + Rerank（完整链路） | **1.0000** | **0.9577** | **0.9648** | 19919 ms |
...
但平均延迟从 **88.8 ms 涨到 19919 ms（约 224 倍）**。结论很明确：
